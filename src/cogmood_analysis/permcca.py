...
def permcca(Y, X, nP=1000, Z=None, W=None, Sel=None, partial=True, Pset=None, return_projected_rperm=False):
 ...
 # - V   : Canonical variables, right side.
    ...
    if return_projected_rperm:
        return pfwer, r, A, B, Qz @ Y @ A, Qw @ X @ B, rperm_list, rperm_list_projected
    else:
